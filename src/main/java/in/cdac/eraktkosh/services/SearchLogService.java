...
public class SearchLogService {
	...
	public SearchLogResponseDTO logSearch(SearchLogRequestDTO request, HttpServletRequest httpRequest)
		...
		return searchLogRepository.saveSearchLog(request.getServiceType(), searchJson, ipAddress);
	}
}