...
public class SearchLogRepository {
    ...
    public SearchLogRepository(JdbcTemplate jdbcTemplate, QueryLoader queryLoader) {
        ...
        this.simpleJdbcInsert = new SimpleJdbcInsert(jdbcTemplate)
                .withTableName("hbbt_eraktkosh_service_search_log")
        ...
        try {
            ...
            return jdbcTemplate.queryForObject(
                ...
                (rs, rowNum) -> {
                    ...
                    return new SearchLogResponseDTO(
                        "success",
                        rs.getLong("hbnum_log_id"),
                        timestamp
                    );
                }
            );
    ...
    private final RowMapper<SearchLogResponseDTO> searchLogRowMapper = (rs, rowNum) -> 
        new SearchLogResponseDTO(
                "success",
                rs.getLong("hbnum_log_id"),
                rs.getTimestamp("gdt_entry_date").toLocalDateTime()
        );
}