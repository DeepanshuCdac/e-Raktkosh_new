...
public class SubscribeDonorRepository {
	...
	public int saveUser(SubscribeDonorDTO donorDTO) {
		...
		return jdbcTemplate.update(query, generatedSerialNo, donorDTO.getStateCode(), donorDTO.getDistrictCode(), 0,
				donorDTO.getMobileNo() != null ? donorDTO.getMobileNo() : null, donorDTO.getEmail());
	}
	...
	public int reSubscribeUser(SubscribeDonorDTO donorDTO) {
		...
		return jdbcTemplate.update(query, donorDTO.getStateCode(), donorDTO.getDistrictCode(),
				donorDTO.getMobileNo() != null ? donorDTO.getMobileNo() : null, 0, donorDTO.getEmail());
	}
}
