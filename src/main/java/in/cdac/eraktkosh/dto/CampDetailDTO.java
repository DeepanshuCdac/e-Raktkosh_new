...
// Getters
	...
	public Integer getIsPortalRegistration() {
		return isPortalRegistration;
	}
...
// Setters
	...
	public void setCampReqNo(Long campReqNo) {
		this.campReqNo = campReqNo;
	}
	...
	public void setIsPortalRegistration(Integer isPortalRegistration) {
		this.isPortalRegistration = isPortalRegistration;
	}
...
// toString method
	...
	public String toString() {
		return "CampDetailDTO{" + "campDate='" + campDate + '\'' + ", campTime='" + campTime + '\'' + ", campName='"
				+ campName + '\'' + ", campVenue='" + campVenue + '\'' + ", contact='" + contact + '\''
				+ ", conductedBy='" + conductedBy + '\'' + ", hospName='" + hospName + '\'' + ", campReqNo=" + campReqNo
				+ ", type=" + type + ", isPortalRegistration=" + isPortalRegistration + ", stateName='" + stateName
				+ '\'' + ", districtName='" + districtName + '\'' + ", dateToSort='" + dateToSort + '\'' + '}';
	}
